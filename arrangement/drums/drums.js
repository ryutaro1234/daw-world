...
$(function() {
  $("#bass10").click(function(){
    $("#bass10").addClass("active");
    setTimeout(() => {document.querySelector("#bass10").classList.remove("active");}, 100);
    $("#bass10-shell").addClass("active");
    setTimeout(() => {document.querySelector("#bass10-shell").classList.remove("active");}, 100);
    $('#bass10Audio')[0].currentTime = 0;
    $('#bass10Audio')[0].play();
  });
});

$(function() {
  $("#snare10").click(function(){
    $("#snare10").addClass("active");
    setTimeout(() => {document.querySelector("#snare10").classList.remove("active");}, 100);
    $("#snare10-shell").addClass("active");
    setTimeout(() => {document.querySelector("#snare10-shell").classList.remove("active");}, 100);
    $('#snare10Audio')[0].currentTime = 0;
    $('#snare10Audio')[0].play();
  });
});

$(function() {
  $("#hi10-tam").click(function(){
    $("#hi10-tam").addClass("active");
    setTimeout(() => {document.querySelector("#hi10-tam").classList.remove("active");}, 100);
    $("#hi10-shell").addClass("active");
    setTimeout(() => {document.querySelector("#hi10-shell").classList.remove("active");}, 100);
    $('#hi10tamAudio')[0].currentTime = 0;
    $('#hi10tamAudio')[0].play();
  });
});

$(function() {
  $("#mid10-tam").click(function(){
    $("#mid10-tam").addClass("active");
    setTimeout(() => {document.querySelector("#mid10-tam").classList.remove("active");}, 100);
    $("#mid10-shell").addClass("active");
    setTimeout(() => {document.querySelector("#mid10-shell").classList.remove("active");}, 100);
    $('#mid10tamAudio')[0].currentTime = 0;
    $('#mid10tamAudio')[0].play();
  });
});

$(function() {
  $("#low10-tam").click(function(){
    $("#low10-tam").addClass("active");
    setTimeout(() => {document.querySelector("#low10-tam").classList.remove("active");}, 100);
    $("#low10-shell").addClass("active");
    setTimeout(() => {document.querySelector("#low10-shell").classList.remove("active");}, 100);
    $('#low10tamAudio')[0].currentTime = 0;
    $('#low10tamAudio')[0].play();
  });
});

$(function() {
  $("#clash10-r").click(function(){
    $("#clash10-r").addClass("active");
    setTimeout(() => {document.querySelector("#clash10-r").classList.remove("active");}, 100);
    $('#clash10rAudio')[0].currentTime = 0;
    $('#clash10rAudio')[0].play();
  });
});

$(function() {
  $("#clash10-l").click(function(){
    $("#clash10-l").addClass("active");
    setTimeout(() => {document.querySelector("#clash10-l").classList.remove("active");}, 100);
    $('#clash10lAudio')[0].currentTime = 0;
    $('#clash10lAudio')[0].play();
  });
});

$(function() {
  $("#hat10").click(function(){
    $("#hat10").addClass("active");
    setTimeout(() => {document.querySelector("#hat10").classList.remove("active");}, 100);
    $('#ride10Audio')[0].currentTime = 0;
    $('#ride10Audio')[0].play();
  });
});

$(function() {
  $("#ride10").click(function(){
    $("#ride10").addClass("active");
    setTimeout(() => {document.querySelector("#ride10").classList.remove("active");}, 100);
    $('#hihat10Audio')[0].currentTime = 0;
    $('#hihat10Audio')[0].play();
  });
});
