...
//musicBox3
$(function() {
  $("#box3_1_1").click(function(){
    if ($(this).hasClass("active")) {}
    else if (!$(this).hasClass("active")) {
      $(this).addClass("active");
      $("#box3_1_2").removeClass("active");
      $("#box3_1_3").removeClass("active");
    }
  });
});

$(function() {
  $("#box3_1_2").click(function(){
    if ($(this).hasClass("active")) {}
    else if (!$(this).hasClass("active")) {
      $(this).addClass("active");
      $("#box3_1_1").removeClass("active");
      $("#box3_1_3").removeClass("active");
    }
  });
});
...
$(function() {
  $("#box3_2_1").click(function(){
    if ($(this).hasClass("active")) {}
    else if (!$(this).hasClass("active")) {
      $(this).addClass("active");
      $("#box3_2_2").removeClass("active");
      $("#box3_2_3").removeClass("active");
    }
  });
});

$(function() {
  $("#box3_2_2").click(function(){
    if ($(this).hasClass("active")) {}
    else if (!$(this).hasClass("active")) {
      $(this).addClass("active");
      $("#box3_2_1").removeClass("active");
      $("#box3_2_3").removeClass("active");
    }
  });
});
...
$(function() {
  $("#box3_3_1").click(function(){
    if ($(this).hasClass("active")) {}
    else if (!$(this).hasClass("active")) {
      $(this).addClass("active");
      $("#box3_3_2").removeClass("active");
      $("#box3_3_3").removeClass("active");
    }
  });
});

$(function() {
  $("#box3_3_2").click(function(){
    if ($(this).hasClass("active")) {}
    else if (!$(this).hasClass("active")) {
      $(this).addClass("active");
      $("#box3_3_1").removeClass("active");
      $("#box3_3_3").removeClass("active");
    }
  });
});
...
$(function() {
  $("#play3").click(function(){
    if ($(this).hasClass("active")) {
      ...
      $('#audio3_1_1_1')[0].pause();
      $('#audio3_1_2_1')[0].pause();
      $('#audio3_1_3_1')[0].pause();

      $('#audio3_1_1_2')[0].pause();
      $('#audio3_1_2_2')[0].pause();
      $('#audio3_1_3_2')[0].pause();

      $('#audio3_1_1_3')[0].pause();
      $('#audio3_1_2_3')[0].pause();
      $('#audio3_1_3_3')[0].pause();


      $('#audio3_2_1_1')[0].pause();
      $('#audio3_2_2_1')[0].pause();
      $('#audio3_2_3_1')[0].pause();

      $('#audio3_2_1_2')[0].pause();
      $('#audio3_2_2_2')[0].pause();
      $('#audio3_2_3_2')[0].pause();

      $('#audio3_2_1_3')[0].pause();
      $('#audio3_2_2_3')[0].pause();
      $('#audio3_2_3_3')[0].pause();


      $('#audio3_3_1_1')[0].pause();
      $('#audio3_3_2_1')[0].pause();
      $('#audio3_3_3_1')[0].pause();

      $('#audio3_3_1_2')[0].pause();
      $('#audio3_3_2_2')[0].pause();
      $('#audio3_3_3_2')[0].pause();

      $('#audio3_3_1_3')[0].pause();
      $('#audio3_3_2_3')[0].pause();
      $('#audio3_3_3_3')[0].pause();


      $('#audio3_1_1_1')[0].currentTime = 0;
      $('#audio3_1_2_1')[0].currentTime = 0;
      $('#audio3_1_3_1')[0].currentTime = 0;

      $('#audio3_1_1_2')[0].currentTime = 0;
      $('#audio3_1_2_2')[0].currentTime = 0;
      $('#audio3_1_3_2')[0].currentTime = 0;

      $('#audio3_1_1_3')[0].currentTime = 0;
      $('#audio3_1_2_3')[0].currentTime = 0;
      $('#audio3_1_3_3')[0].currentTime = 0;


      $('#audio3_2_1_1')[0].currentTime = 0;
      $('#audio3_2_2_1')[0].currentTime = 0;
      $('#audio3_2_3_1')[0].currentTime = 0;

      $('#audio3_2_1_2')[0].currentTime = 0;
      $('#audio3_2_2_2')[0].currentTime = 0;
      $('#audio3_2_3_2')[0].currentTime = 0;

      $('#audio3_2_1_3')[0].currentTime = 0;
      $('#audio3_2_2_3')[0].currentTime = 0;
      $('#audio3_2_3_3')[0].currentTime = 0;


      $('#audio3_3_1_1')[0].currentTime = 0;
      $('#audio3_3_2_1')[0].currentTime = 0;
      $('#audio3_3_3_1')[0].currentTime = 0;

      $('#audio3_3_1_2')[0].currentTime = 0;
      $('#audio3_3_2_2')[0].currentTime = 0;
      $('#audio3_3_3_2')[0].currentTime = 0;

      $('#audio3_3_1_3')[0].currentTime = 0;
      $('#audio3_3_2_3')[0].currentTime = 0;
      $('#audio3_3_3_3')[0].currentTime = 0;
      ...
      $("#box3_2_1").removeClass("play");
      $("#box3_2_2").removeClass("play");
      $("#box3_2_3").removeClass("play");
      ...
      if ($("#box3_1_1").hasClass("active")) {
        if ($("#box3_2_1").hasClass("active")) {
          if ($("#box3_3_1").hasClass("active")) {
            $("#audio3_1_1_1")[0].play();
            $("#box3_1_1").addClass("play");
            $("#box3_2_1").addClass("play");
            $("#box3_3_1").addClass("play");
          }else {};
        }else {};
      }else {};
      ...
      if ($("#box3_1_1").hasClass("active")) {
        if ($("#box3_2_1").hasClass("active")) {
          if ($("#box3_3_2").hasClass("active")) {
            $("#audio3_1_1_2")[0].play();
            $("#box3_1_1").addClass("play");
            $("#box3_2_1").addClass("play");
            $("#box3_3_2").addClass("play");
          }else {};
        }else {};
      }else {};
      ...
      if ($("#box3_1_1").hasClass("active")) {
        if ($("#box3_2_1").hasClass("active")) {
          if ($("#box3_3_3").hasClass("active")) {
            $("#audio3_1_1_3")[0].play();
            $("#box3_1_1").addClass("play");
            $("#box3_2_1").addClass("play");
            $("#box3_3_3").addClass("play");
          }else {};
        }else {};
      }else {};
      ...
      if ($("#box3_1_1").hasClass("active")) {
        if ($("#box3_2_2").hasClass("active")) {
          if ($("#box3_3_1").hasClass("active")) {
            $("#audio3_1_2_1")[0].play();
            $("#box3_1_1").addClass("play");
            $("#box3_2_2").addClass("play");
            $("#box3_3_1").addClass("play");
          }else {};
        }else {};
      }else {};
      ...
      if ($("#box3_1_1").hasClass("active")) {
        if ($("#box3_2_3").hasClass("active")) {
          if ($("#box3_3_1").hasClass("active")) {
            $("#audio3_1_3_1")[0].play();
            $("#box3_1_1").addClass("play");
            $("#box3_2_3").addClass("play");
            $("#box3_3_1").addClass("play");
          }else {};
        }else {};
      }else {};
      ...
      if ($("#box3_1_2").hasClass("active")) {
        if ($("#box3_2_1").hasClass("active")) {
          if ($("#box3_3_1").hasClass("active")) {
            $("#audio3_2_1_1")[0].play();
            $("#box3_1_2").addClass("play");
            $("#box3_2_1").addClass("play");
            $("#box3_3_1").addClass("play");
          }else {};
        }else {};
      ...
      if ($("#box3_1_3").hasClass("active")) {
        if ($("#box3_2_1").hasClass("active")) {
          if ($("#box3_3_1").hasClass("active")) {
            $("#audio3_3_1_1")[0].play();
            $("#box3_1_3").addClass("play");
            $("#box3_2_1").addClass("play");
            $("#box3_3_1").addClass("play");
          }else {};
        }else {};
